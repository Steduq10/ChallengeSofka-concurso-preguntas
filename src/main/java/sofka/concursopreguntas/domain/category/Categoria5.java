...
public class Categoria5 {
    ...
    public String resultado() {
        ...
        if (respuesta.contains("Para una clase")) {
        ...
        else if (respuesta.contains("¿Qué es una")) {
            System.out.println(respuesta);
            System.out.println("¿Su respuesta es?: ");
            Scanner consola = new Scanner(System.in);
            var respuesta = consola.nextLine();
        ...
        else if (respuesta.contains("Que lenguajes")) {
            System.out.println(respuesta);
            System.out.println("¿Su respuesta es?: ");
            Scanner consola = new Scanner(System.in);
            var respuesta = consola.nextLine();
        ...
        else if (respuesta.contains("El servidor")) {
            System.out.println(respuesta);
            System.out.println("¿Su respuesta es?: ");
            Scanner consola = new Scanner(System.in);
            var respuesta = consola.nextLine();
        ...
        else if (respuesta.contains("Qué es un algoritmo")) {
            System.out.println(respuesta);
            System.out.println("¿Su respuesta es?: ");
            Scanner consola = new Scanner(System.in);
            var respuesta = consola.nextLine();
